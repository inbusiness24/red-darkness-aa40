...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/red-darkness-aa40)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/red-darkness-aa40
```

A live public deployment of this template is available at [https://red-darkness-aa40.templates.workers.dev](https://red-darkness-aa40.templates.workers.dev)
